...
class ProjectManagement:
    ...
    def print_main_command_options(self):
        commands_main = {"1": "add team members to the project team", "2": "create a project phase", "3": "add a task to a project phase", "4": "show display options", "x": "exit"}
        print("Select action")
    ...
    def print_display_command_options(self):
        commands_display = {"1": "display team members", "2": "display project phases", "3": "display tasks", "4": "display project estimates on phase level", "x": "return"}
